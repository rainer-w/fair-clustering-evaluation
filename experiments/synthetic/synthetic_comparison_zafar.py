...
def run_zafar(path,seed,n):
    
    fairdegen = ZafarGenerator([[2,2], [-2,-2]], [[[5, 1],[1, 5]],[[10, 1],[1, 3]]], 180)
...
def main_zafar(run=True,plot=True):
    
    SEEDS = [11,22,33,44,55] 
    base_path = "results/synthetic/ZafarGenerator/"
    if run:
        for seed in SEEDS:
            ...
            for n in [500, 1000, 2000, 5000, 10000]:
                opt_df, all_df = run_zafar(path,seed,n=n)
