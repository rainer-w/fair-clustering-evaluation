...
from src.generators.blob_generator import BlobGenerator
...
def run_blob(path,seed,n):
    
    fairdegen = BlobGenerator()
...
def main_blob(run=True,plot=True):
    
    SEEDS = [11,22,33,44,55] 
    base_path = "results/synthetic/BlobGenerator/"
    if run:
        for seed in SEEDS:
            ...
            for n in [500, 1000, 2000, 5000, 10000]:
                opt_df, all_df = run_blob(path,seed,n=n)
